...
GLBA_REQUIREMENTS = {
    ...
    'multi_factor_auth': {
        ...
        'controls': ['TOTP/FIDO2', 'Device fingerprinting', 'Session management'],
        'implemented': False,
    },
    'data_disposal': {
        'section': '§314.4(c)(6)',
        ...
        'controls': ['Secure deletion', 'Retention schedules', 'Disposal audit trail'],
        'implemented': False,
    },
    'change_management': {
        'section': '§314.4(c)(7)',
        ...
        'controls': ['Change request process', 'Impact assessment', 'Rollback procedures'],
        'implemented': False,
    },
    'audit_monitoring': {
        'section': '§314.4(c)(8)',
    ...
    'employee_training': {
        ...
        'controls': ['Security awareness', 'Phishing simulation', 'Compliance training'],
        'implemented': False,
    },
    'vendor_management': {
        'section': '§314.4(f)',
